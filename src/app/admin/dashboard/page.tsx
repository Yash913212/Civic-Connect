...
function AdminDashboard() {
  ...
  return (
    <main className="bg-transparent text-slate-900 dark:text-white min-h-screen pt-32 pb-24 relative overflow-hidden flex flex-col justify-between selection:bg-orange-500/20 dark:selection:bg-white/20">
      ...
      <div className="container mx-auto px-6 relative z-10 flex-grow w-full max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 border-b border-black/10 dark:border-white/10 pb-6">
          <div>
            <span className="text-xs uppercase tracking-[0.2em] font-bold text-orange-600 dark:text-purple-500 mb-2 block">
              Operations Center
            </span>
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-semibold rounded-xl border transition-all text-left ${
                    isActive
                      ? "bg-orange-500/10 border-orange-500/30 text-orange-600 shadow-[0_4px_20px_rgba(249,115,22,0.15)] dark:bg-purple-500/10 dark:border-purple-500/30 dark:text-purple-400 dark:shadow-[0_0_15px_rgba(139,92,246,0.15)] bg-white dark:bg-transparent"
            ...
            <AnimatePresence mode="wait">
              ...
              {activeTab === "overview" && (
                ...
                >
                  ...
                  >
                    <motion.div variants={{ hidden: { opacity: 0, scale: 0.95 }, show: { opacity: 1, scale: 1 } }} className="p-5 rounded-2xl bg-white dark:bg-white/[0.02] shadow-sm dark:shadow-none border border-black/10 dark:border-white/10 relative overflow-hidden group">
                      <div className="absolute inset-0 bg-white/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                      <FileText className="absolute top-4 right-4 w-12 h-12 text-slate-900/5 dark:text-white/5 group-hover:text-slate-900/10 dark:group-hover:text-white/10 transition-colors" />
                      <span className="text-[10px] font-bold text-slate-500 dark:text-white/50 uppercase tracking-wider block relative z-10">Total Complaints</span>
                      <h3 className="text-3xl font-bold text-slate-900 dark:text-white mt-2 relative z-10">12,402</h3>
                    </motion.div>
                    <motion.div variants={{ hidden: { opacity: 0, scale: 0.95 }, show: { opacity: 1, scale: 1 } }} className="p-5 rounded-2xl bg-amber-500/5 border border-amber-500/20 relative overflow-hidden group">
                      ...
                      <h3 className="text-3xl font-bold text-amber-600 dark:text-amber-400 mt-2 relative z-10">1,240</h3>
                    </motion.div>
                    <motion.div variants={{ hidden: { opacity: 0, scale: 0.95 }, show: { opacity: 1, scale: 1 } }} className="p-5 rounded-2xl bg-emerald-500/5 border border-emerald-500/20 relative overflow-hidden group">
                      ...
                      <h3 className="text-3xl font-bold text-emerald-600 dark:text-emerald-400 mt-2 relative z-10">10,850</h3>
                    </motion.div>
                    <motion.div variants={{ hidden: { opacity: 0, scale: 0.95 }, show: { opacity: 1, scale: 1 } }} className="p-5 rounded-2xl bg-cyan-500/5 border border-cyan-500/20 relative overflow-hidden group">
                      ...
                      <h3 className="text-3xl font-bold text-cyan-600 dark:text-cyan-400 mt-2 relative z-10">A-</h3>
                    </motion.div>
                  </motion.div>

                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                    <div className="p-6 rounded-2xl bg-white dark:bg-white/[0.02] shadow-sm dark:shadow-none border border-black/10 dark:border-white/10 h-80">
                      <h4 className="text-sm font-bold text-slate-700 dark:text-white/80 mb-4">Daily Complaint Trends</h4>
                    ...
                    <div className="p-6 rounded-2xl bg-white dark:bg-white/[0.02] shadow-sm dark:shadow-none border border-black/10 dark:border-white/10 h-80">
                      <h4 className="text-sm font-bold text-slate-700 dark:text-white/80 mb-4">Department Efficiency Score (%)</h4>
                      <ResponsiveContainer width="100%" height="100%">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                    ...
                    <div className="flex gap-2">
                      <div className="relative">
                        <Search className="w-4 h-4 text-slate-500 dark:text-white/40 absolute left-3 top-1/2 transform -translate-y-1/2" />
                        <input type="text" placeholder="Search ID..." className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-lg pl-9 pr-4 py-2 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-orange-500/50 dark:focus:border-purple-500/50 transition-all w-48 shadow-sm dark:shadow-none" />
                      </div>
                      <button className="flex items-center gap-2 px-3 py-2 bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-lg text-sm text-slate-700 dark:text-white/70 hover:bg-slate-50 dark:hover:bg-white/10 transition-colors shadow-sm dark:shadow-none">
                  ...
                  >
                    {complaints.map((item, idx) => (
                      <motion.div 
                        ...
                        key={idx} 
                        className="p-4 rounded-xl bg-white dark:bg-white/[0.01] shadow-sm dark:shadow-none border border-black/10 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-white/[0.03] transition-colors flex flex-col md:flex-row justify-between items-center gap-4 group"
                      >
                        <div className="flex items-center gap-4 w-full md:w-auto">
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              <span className="text-xs font-mono text-slate-500 dark:text-white/40">{item.id}</span>
                              <h4 className="text-sm font-bold text-slate-900 dark:text-white">{item.title}</h4>
                            </div>
                            <div className="flex items-center gap-3 mt-1 text-xs">
                              <span className="text-slate-600 dark:text-white/60 flex items-center gap-1"><Building2 size={12}/> {item.dept}</span>
                              <span className="text-slate-400 dark:text-white/40 flex items-center gap-1"><Clock size={12}/> {item.time}</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 w-full md:w-auto justify-end">
                          ...
                          <button 
                            ...
                            className="px-4 py-2 bg-white dark:bg-white/5 hover:bg-slate-50 dark:hover:bg-white/10 text-slate-900 dark:text-white text-xs font-semibold rounded-lg transition-colors border border-black/10 dark:border-white/10 shadow-sm dark:shadow-none"
                          >
                            Manage
                          </button>
                        </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      ...
                      <div key={i} className="p-6 rounded-2xl bg-white dark:bg-white/[0.02] shadow-sm dark:shadow-none border border-slate-200 dark:border-white/10 hover:border-slate-300 dark:hover:border-white/20 transition-all">
                        <div className="flex justify-between items-start mb-4">
                          ...
                          <button className="text-slate-400 hover:text-slate-600 dark:text-white/40 dark:hover:text-white transition-colors"><Settings size={18}/></button>
                        </div>
                        <div className="flex justify-between text-sm text-slate-500 dark:text-white/60 mb-2">
                          <span>Officers Assigned: <strong className="text-slate-900 dark:text-white">{dept.officerCount}</strong></span>
                          <span>Active Workload: <strong className="text-slate-900 dark:text-white">{dept.activeCases}</strong></span>
                        </div>
                        <div className="w-full h-1.5 bg-slate-100 dark:bg-white/5 rounded-full overflow-hidden mt-4">
                          <motion.div 
                            initial={{ width: 0 }}
                        ...
                        <div className="mt-4 flex gap-2">
                           <button className="flex-1 py-2 bg-slate-50 hover:bg-slate-100 dark:bg-white/5 dark:hover:bg-white/10 border border-slate-200 dark:border-white/10 rounded-lg text-xs font-semibold text-slate-700 dark:text-white/80 transition-colors">Assign Officers</button>
                           <button className="flex-1 py-2 bg-slate-50 hover:bg-slate-100 dark:bg-white/5 dark:hover:bg-white/10 border border-slate-200 dark:border-white/10 rounded-lg text-xs font-semibold text-slate-700 dark:text-white/80 transition-colors">View Queue</button>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              {activeTab === "reports" && (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="p-6 rounded-2xl bg-white dark:bg-white/[0.02] shadow-sm dark:shadow-none border border-slate-200 dark:border-white/10 flex flex-col items-center text-center hover:bg-slate-50 dark:hover:bg-white/[0.04] transition-all cursor-pointer group">
                      ...
                      <h4 className="font-bold text-slate-900 dark:text-white mb-2">Monthly PDF Report</h4>
                      <p className="text-xs text-slate-500 dark:text-white/50 mb-6">Generates comprehensive governance report with charts.</p>
                      <button className="flex items-center gap-2 px-4 py-2 bg-rose-50 dark:bg-rose-500/20 text-rose-600 dark:text-rose-400 rounded-lg text-sm font-bold mt-auto border border-rose-200 dark:border-rose-500/30">
                    ...
                    <div className="p-6 rounded-2xl bg-white dark:bg-white/[0.02] shadow-sm dark:shadow-none border border-slate-200 dark:border-white/10 flex flex-col items-center text-center hover:bg-slate-50 dark:hover:bg-white/[0.04] transition-all cursor-pointer group">
                      ...
                      <h4 className="font-bold text-slate-900 dark:text-white mb-2">Raw Data Export</h4>
                      <p className="text-xs text-slate-500 dark:text-white/50 mb-6">Exports all compliant entries to CSV for offline analysis.</p>
                      <button className="flex items-center gap-2 px-4 py-2 bg-emerald-50 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 rounded-lg text-sm font-bold mt-auto border border-emerald-200 dark:border-emerald-500/30">
                    ...
                    <div className="p-6 rounded-2xl bg-white dark:bg-white/[0.02] shadow-sm dark:shadow-none border border-slate-200 dark:border-white/10 flex flex-col items-center text-center hover:bg-slate-50 dark:hover:bg-white/[0.04] transition-all cursor-pointer group">
                      ...
                      <h4 className="font-bold text-slate-900 dark:text-white mb-2">Department Audit</h4>
                      <p className="text-xs text-slate-500 dark:text-white/50 mb-6">Generates performance summaries for all departments.</p>
                      <button className="flex items-center gap-2 px-4 py-2 bg-blue-50 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 rounded-lg text-sm font-bold mt-auto border border-blue-200 dark:border-blue-500/30">
              ...
              {activeTab === "map" && (
                ...
                >
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <div className="flex gap-2">
                       <button className="px-3 py-1.5 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded text-xs text-slate-600 dark:text-white/70">Heatmap Layer</button>
                       <button className="px-3 py-1.5 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded text-xs text-slate-600 dark:text-white/70">Markers</button>
                    </div>
                  </div>
                  <div className="flex-grow rounded-2xl bg-slate-100 dark:bg-black/50 border border-slate-200 dark:border-white/10 relative overflow-hidden flex items-center justify-center">
                    ...
                    <div className="z-20 p-6 bg-white/80 dark:bg-black/60 backdrop-blur-md border border-slate-200 dark:border-white/10 rounded-xl max-w-sm text-center">
                      <h4 className="text-slate-900 dark:text-white font-bold mb-2">Map Engine Initialized</h4>
                      <p className="text-xs text-slate-600 dark:text-white/60 mb-4">Live connection to geospatial data streams active. Displaying aggregated clusters.</p>
