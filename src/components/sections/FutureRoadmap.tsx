  ...
  return (
    <section id="roadmap" ref={containerRef} className="min-h-screen md:h-screen w-full flex flex-col md:flex-row bg-transparent overflow-hidden relative border-t border-white/5">
      <div className="w-full md:w-1/2 h-auto md:h-full flex flex-col justify-center px-6 py-16 md:py-0 md:px-12 lg:px-24 relative z-10 bg-white/40 dark:bg-black/40 backdrop-blur-md border-b md:border-b-0 md:border-r border-black/5 dark:border-white/10">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold mb-6">Future of <br className="hidden md:block" /><span className="text-primary drop-shadow-[0_0_15px_rgba(37,99,235,0.2)] dark:drop-shadow-[0_0_20px_var(--primary)]">Civic Governance</span></h2>
      ...
      <div className="w-full md:w-1/2 h-auto md:h-full relative overflow-hidden flex flex-col">
        {milestones.map((item, i) => (
          <div key={i} className="roadmap-item flex-shrink-0 h-auto md:h-full w-full flex flex-col justify-center px-6 md:px-20 py-12 md:py-0 border-b border-black/5 dark:border-white/5 last:border-0">
            <div className="text-[60px] md:text-[120px] font-bold text-black/5 dark:text-white/5 leading-none mb-2 md:mb-4 tracking-tighter whitespace-nowrap">{2026 + i}</div>
